...
In particular, the election-level panel generated in this do-file is used in
creating Figure 3 and Figure 4 in the main body of the paper as well as Table B2,
Figure C1, Figure C2, Figure C3, Table C2, Table C3, Table C4 in the Online Appendix.
These figures and tables implement the RD strategy in an election-level panel that
examines the data one year at a time. This allows me to implement cross-sectional
RD strategies to test the robustness of the main findings to the a cross-sect. approach.

DATA INPUTS: (1) referendum, (2) cpiu, (3) membership_1993_2018 (4) Master_Admin_Data
DATA OUTPUTS: (1) itt_cross_section
*********************************/
**Set Globals
...
******ITT PANEL CREATION
*****************************************
*Get referendum data ready for ITT estimator panel
...
*This is a proposal-level dataset.
...
foreach v in op_ismeas bond_ismeas op_iswin bond_iswin{
	replace `v'=1 if `v'>=1
}
	
*Save this dataset
save "${path}Data\Final\itt_cross_section", replace
